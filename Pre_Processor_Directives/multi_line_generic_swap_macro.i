# 1 "multi_line_generic_swap_macro.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "multi_line_generic_swap_macro.c"
...
# 2 "multi_line_generic_swap_macro.c" 2
...
# 3 "multi_line_generic_swap_macro.c" 2
# 13 "multi_line_generic_swap_macro.c"
...
int main()
{
 ...
 printf("c1:%c, c2:%c\n",c1, c2 );
 { char temp; temp = c1; c1 = c2; c2 = temp; };
 printf("c1:%c, c2:%c\n\n",c1, c2 );

 printf("f1:%.2f, f2:%.2f\n",f1, f2 );
 { float temp; temp = f1; f1 = f2; f2 = temp; };
 printf("f1:%.2f, f2:%.2f\n\n",f1, f2 );
